    ...
    const vendors = [
      {
        ...
        deskripsi_toko:
          "Pusat aktivitas bahari dan open tur di kawasan 3 Gili Lombok.",
      ...
      },
      {
        ...
        deskripsi_toko:
          "Sewa & jual perlengkapan selam dan snorkeling berkualitas.",
      ...
      },
      {
        ...
        deskripsi_toko:
          "Penginapan nyaman dengan pemandangan langsung menghadap pantai Gili.",
      ...
      },
      {
        ...
        deskripsi_toko:
          "Seafood segar hasil tangkapan nelayan lokal dengan sambal rahasia.",
      ...
      },
      {
        ...
        deskripsi_toko:
          "Jasa foto profesional darat, bawah air, dan dokumentasi drone.",
      ...
      {
        id: uuidv4(),
        user_id: getUserId("v6.marwah@divexplore.id"),
        nama_toko: "Warung Ikan Bakar Ibu Marwah",
        deskripsi_toko:
          "Kuliner ikan bakar khas Lombok dengan bumbu autentik Ibu Marwah.",
        nama_penanggung_jawab: "Ibu Marwah",
        no_telepon_bisnis: "081234560006",
        kategori: "kuliner",
        alamat_lengkap: "Jl. Pariwisata, Gili Trawangan, NTB",
        link_google_maps: "https://maps.google.com/?q=Gili+Trawangan",
        persentase_komisi: 10,
        status_kyc: "approved",
        saldo_saat_ini: 0,
      ...
      {
        id: uuidv4(),
        user_id: getUserId("v7.oleholeh@divexplore.id"),
        nama_toko: "Oleh-oleh Bahari DIVEXPLORE",
        deskripsi_toko:
          "Pusat oleh-oleh khas laut terlengkap, dari dodol rumput laut hingga abon tuna.",
        nama_penanggung_jawab: "Admin Oleh-oleh",
        no_telepon_bisnis: "081234560007",
        kategori: "kuliner",
        alamat_lengkap: "Area Pelabuhan Gili Trawangan, NTB",
        link_google_maps: "https://maps.google.com/?q=Pelabuhan+Gili+Trawangan",
        persentase_komisi: 10,
        status_kyc: "approved",
        saldo_saat_ini: 0,
        createdAt: now,
